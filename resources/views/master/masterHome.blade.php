...
<head>
    <meta charset="utf-8">
    <title>Siloker - Website Job Portal Wilayah Kota Sabang dan Sekitarnya</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="" name="keywords">
    <meta content="" name="description">

    <!-- Favicon -->
    <link href="{{asset('jobentry-1.0.0/img/favicon.ico')}}" rel="icon">
...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <a href="{{ route('login') }}" class="btn btn-primary rounded-0 py-4 px-lg-5 d-none d-lg-block">Login Admin<i class="fa fa-arrow-right ms-3"></i></a>
            </div>
        </nav>
        <!-- Navbar End -->
    ...
    <script src="{{asset('jobentry-1.0.0/lib/wow/wow.min.js')}}"></script>
    <script src="{{asset('jobentry-1.0.0/lib/easing/easing.min.js')}}"></script>
    <script src="{{asset('jobentry-1.0.0/lib/waypoints/waypoints.min.js')}}"></script>
    <script src="{{asset('jobentry-1.0.0/lib/owlcarousel/owl.carousel.min.js')}}"></script>

    <!-- Template Javascript -->
    <script src="{{asset('jobentry-1.0.0/js/main.js')}}"></script>
</body>
